...
def parse_args():
    ...
    parser.add_argument("--config", type=str, default="configs/rl_box.yaml")
    parser.add_argument("--output_dir", type=str, default="outputs/rl_box")
...
def main():
    ...
    logger = setup_logger("rl_box", log_file=str(output_dir / "train.log"))
    ...
    logger.info("RL (box) training complete.")
