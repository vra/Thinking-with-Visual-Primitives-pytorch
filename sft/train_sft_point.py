...
def parse_args():
    ...
    parser.add_argument("--config", type=str, default="configs/sft_point.yaml")
    parser.add_argument("--output_dir", type=str, default="outputs/sft_point")
...
def main():
    ...
    logger = setup_logger("sft_point", log_file=str(output_dir / "train.log"))
    ...
    logger.info("SFT (point) complete.")
